		...
		<tbody>
			<tr>
				...
				<td style="text-align:center; font-size:13pt; font-family:'Times New Roman'">
					<p style="margin:0;padding:0;">Republik Filipina</p>
					<p style="margin:0;padding:0;font-weight:bold;">PERGURUAN TINGGI NEGERI PERINGATAN CARLOS HILADO</p>
			...
			<tr>
				<td></td>
				<td style="text-align:center; font-weight:bold; padding:30px 0; font-size:18pt; font-family:'Bookman Old Style'; text-transform: uppercase;">Kwitansi Bukti Peminjaman</td>
				<td></td>
			</tr>
			<tr>
				<td colspan="3" style="font-size:16pt;">Nama: <?php echo $data[0]['m_fname']; ?> <?php echo $data[0]['m_lname']; ?></td>
			</tr>
			<tr>
				<td colspan="3" style="font-size:16pt;">Ruang: <?php echo ucfirst($data[0]['rm_name']); ?></td>
			</tr>
			<tr>
				<td colspan="3">
					<table style="width:100%; border:1px solid #000; border-bottom: none;" cellpadding="0" cellspacing="0">
						<thead>
							<tr>
								<th style="padding:5px; font-size:14pt; font-family:'Calibri'; border-bottom:1px solid #000;">Ketegori</th>
								<th style="padding:5px; font-size:14pt; font-family:'Calibri'; border-bottom:1px solid #000; border-left:1px solid #000;">Merek</th>
							</tr>
						</thead>
						<tbody>
