...
<body class="">
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color: #282a36;">
				...
				<ul class="user-menu">
					...
					<li class="dropdown pull-right notification">
						...
						<ul class="dropdown-menu" role="menu">
							<li>
								<a href="reservation">
									<span id="reserveBadge2" class="today_reservation badge"></span> - Reservasi Hari Ini
								</a>
							</li>
						</ul>
					</li>
					<li class="dropdown pull-right notification">
						...
						<ul class="dropdown-menu" role="menu">
							<li>
								<a href="borrow">
									<span id="dueBorrow" class="badge"></span> - Batas Waktu Peminjaman
								</a>
							</li>
						</ul>
					</li>
